	...
	if(menu) {
		...
		switch(tag) {
			...
			case 'tbl':
				...
				break;
			case 'aud':
				str = '<p class="pbn">请输入音乐文件地址:</p><p class="pbn"><input type="text" id="' + ctrlid + '_param_1" class="px" value="" style="width: 220px;" /></p><p class="xg2 pbn">支持 mp3 ogg 等音乐格式<br />示例: http://server/audio.mp3</p>';
				break;
			case 'vid':
